...
class ChatBot:
    ...
    def send_prompt(self, prompt, temperature=0.1):
        ...
        try:
            ...
            content=prompt, generation_config=self._generation_config(temperature),
    ...
    def preload_conversation(self, conversation_history =None):
        ...
        if isinstance(conversation_history, list):
            ...
            self._conversation_history = [
                ...
                self._construct_message('{"text": "sure i can return the output as a regular json object with the key as `text`. here is an example:{"text": "your output"}.')
            ]